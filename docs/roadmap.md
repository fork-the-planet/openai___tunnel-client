...
This document captures forward-looking ideas. It is **not** a guarantee of behavior or a commitment to a timeline.
...
- **Tracing**
  - Add end-to-end trace context propagation and OpenTelemetry spans across poll → MCP → response.
