...
func TestEmbeddedSourceVersionMatchesRelease(t *testing.T) {
	if got := strings.TrimSpace(sourceSemanticVersion); got != "0.0.10" {
		t.Fatalf("expected source VERSION to be 0.0.10, got %q", got)
	}
}
